...
import { Shield, Lock, CheckCircle, ArrowRight, UserPlus, RefreshCcw, Server, Key } from 'lucide-react';
        ...
        <div className="container px-4">
          ...
          >
            <div className="flex-1 space-y-6 md:pr-8">
              ...
              >
                Keep your data <span className="gradient-text">protected</span> with Guard
              </motion.h1>
              <motion.p 
                variants={fadeInUp}
              ...
              >
                ...
                Our automated backup system ensures your data is always secure and recoverable.
              </motion.p>
              <motion.div 
                variants={fadeInUp}
                  ...
                  <div className="p-8 relative z-10">
                    <div className="grid grid-cols-2 gap-4 mb-8">
                      <div className="col-span-2 flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-xl font-semibold">Guard Dashboard</h3>
                          <p className="text-muted-foreground">Security status: Protected</p>
                        </div>
                      </div>
                      
                      {[
                        { icon: <RefreshCcw className="h-5 w-5 text-green-500" />, label: "Real-time backups", color: "bg-green-500/10" },
                        { icon: <Lock className="h-5 w-5 text-primary" />, label: "Encryption active", color: "bg-primary/10" },
                        { icon: <Server className="h-5 w-5 text-amber-500" />, label: "Database secure", color: "bg-amber-500/10" },
                        { icon: <Key className="h-5 w-5 text-purple-500" />, label: "Access control", color: "bg-purple-500/10" }
                      ].map((item, i) => (
                        <div key={i} className="p-4 rounded-xl bg-card border border-border/50 flex items-center space-x-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">Data protection status: 85% complete</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
        ...
        <div className="container px-4">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-lg text-muted-foreground">
              Our robust platform offers all the security features your business needs
            </motion.p>
          </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "Fine-grained permissions let you control who can access and restore backups."
              },
              {
                icon: <UserPlus className="h-6 w-6 text-primary" />,
                title: "Team Collaboration",
                description: "Work together with your team to manage backups and ensure data protection."
              }
            ].map((feature, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-full w-full bg-card border border-border/50 rounded-3xl shadow-xl overflow-hidden">
                  ...
                  <div className="p-8 relative z-10 h-full flex flex-col">
                    ...
                    <div className="flex-grow grid grid-cols-2 gap-4">
                      {[
                        { label: "Encryption", status: "Active", color: "bg-green-500" },
                        { label: "Firewall", status: "Protected", color: "bg-green-500" },
                        { label: "Data Access", status: "Restricted", color: "bg-green-500" },
                        { label: "Backup Status", status: "Up-to-date", color: "bg-green-500" }
                      ].map((item, i) => (
                        <div key={i} className="flex flex-col space-y-2 bg-background/50 p-4 rounded-xl">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6">
                We take security <span className="gradient-text">seriously</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                Our platform is built from the ground up with security as the primary focus.
                Every component, from authentication to storage, is designed with multiple layers of protection.
              </p>
                ...
                {[
                  {
                    ...
                    description: "Your data is encrypted at rest and in transit using industry-standard AES-256 encryption"
                  },
                  {
                    title: "Regular Security Audits",
                    description: "Our systems undergo rigorous third-party security assessments and penetration testing"
                  },
                  {
                    title: "Compliance Ready",
                    description: "Designed to help meet regulatory requirements including GDPR, HIPAA, and SOC 2"
                  }
                ].map((item, i) => (
      ...
      <section id="trust" className="py-24 relative z-10">
        <div className="container px-4">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-lg text-muted-foreground">
              Organizations of all sizes trust Guard to protect their most valuable data
            </motion.p>
          </motion.div>
          ...
          >
            {[
              {
                quote: "Guard transformed how we approach data security. The automated backups give us confidence that our systems are protected.",
                author: "Sarah Johnson",
                role: "CTO, TechCorp"
              },
              {
                quote: "After a server crash, we were able to restore our entire database in minutes. The reliability and speed are impressive.",
                author: "Michael Chen",
                role: "Database Administrator"
              },
              {
                quote: "The peace of mind that comes with knowing our data is safely backed up is invaluable. The interface is both intuitive and powerful.",
        ...
        <div className="container px-4">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join organizations that trust Guard for their critical data protection needs.
              </p>
